...
-(void) initLayout
{
    ...
    self.authorTag.lineBreakMode = NSLineBreakByWordWrapping;
    ...
    self.publishTag.lineBreakMode = NSLineBreakByWordWrapping;
    ...
    self.publishLabel.lineBreakMode = NSLineBreakByWordWrapping;
